...
{
let team1forruns = teaminfo1.forRuns+RunToChase+1
...
let team1againstruns = teaminfo1.againstRuns+RunToChase;
...
let team2forruns = teaminfo2.forRuns+RunToChase
...
let team2againstruns = teaminfo2.againstRuns+RunToChase+1;
...
getdecimal =  ((teaminfo1.againstOvers - Math.floor(teaminfo1.againstOvers))*10)/6;
let team1againstovers = Math.floor(teaminfo1.againstOvers)+getdecimal + Overs;
let tmp = ((lowerlimit-Math.floor(lowerlimit))*10)/6
lowerlimit = Math.floor(lowerlimit)+tmp;
